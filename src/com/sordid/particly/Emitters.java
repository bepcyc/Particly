...
import org.anddev.andengine.entity.particle.initializer.*;
...
public class Emitters {
    private static final ExpireModifier sLongExpires = new ExpireModifier(3.5f);
    private static final ExpireModifier sShortExpires = new ExpireModifier(2.5f);
