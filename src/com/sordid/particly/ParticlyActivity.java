...
public class ParticlyActivity extends BaseGameActivity implements IOnSceneTouchListener, IOnMenuItemClickListener {
    ...
    private final Vector2 mGravityVector = new Vector2(0, SensorManager.GRAVITY_EARTH);
    ...
    public final Handler data = new Handler() {
        @Override
        public void handleMessage(Message msg) {
            new StatsTask().execute(ParticlyActivity.sStats, getApplicationContext());
        }
    };
    public final IUpdateHandler ballUpdateHandler = new IUpdateHandler() {
    ...
    public boolean onMenuItemClicked(MenuScene pMenuScene, IMenuItem pMenuItem,
        ...
        switch (pMenuItem.getID()) {
            case MENU_RESET:
                ...
                return true;
            case MENU_NEXT:
                if (this.mMenuScene.mItems.get("menuNext").isVisible()) {
                    // Remove the menu and reset the game
    ...
    public void showMenu(boolean showNext) {
        if (mScene.hasChildScene()) {
            ...
            this.mMenuScene.mItems.get("menuNext").setVisible(showNext);
            this.mMenuScene.buildAnimations();
