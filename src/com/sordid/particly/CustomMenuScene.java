...
public class CustomMenuScene extends MenuScene {
    ...
    protected final HashMap<String, IShape> mItems = new HashMap<String, IShape>();
    ...
    public CustomMenuScene add(Shape pEntity) {
        ...
        if (name.equals("SpriteMenuItem")
            ...
            this.getFirstChild().attachChild(pEntity);
            if (name.equals("SpriteMenuItem") || name.equals("AnimatedSpriteMenuItem")) {
                this.registerTouchArea(pEntity);
            }
        }
    ...
    public class MenuContainer {
        ...
        final ArrayList<Object> mEntities = new ArrayList<Object>();
